...
public static class NVJOBNameGen
{
    ...
    public static string GiveAName(int type)
    {
        ...
        if (type > 0)
        {
            ...
            {
                if (type == 1)  // edit to original -- combining all female and male names 
                {
                    firstName = new string[] { "Alicia", "Amanda", "Amy", "Angela", "Anna", "Anne", "Annie", "April", "Audrey", "Barbara", "Becky", "Belinda",
                        ...
                        "Rosalie", "Rosemarie", "Rosie", "Stella", "Thelma", "Velma", "Vera", "Verna", "Viola", "Violet", "Willie", "Wilma", "Yvonne" ,"Aaliyah", "Abby", "Abigail", "Addison", "Adriana", "Adrianna", "Alana", "Alejandra", "Alexa", "Alexandra",
                        ...
                        "Tracie", "Tracy", "Tricia", "Virginia", "Wanda", "Wendy", "Yolanda", "Yvonne", "Aaron", "Adam", "Alan", "Albert", "Alexander", "Alfred", "Allan", "Allen", "Alvin", "Andre", "Andrew", "Anthony",
                        ...
                        "Sidney", "Virgil", "Wallace", "Wendell", "Wilbur", "Willard", "Willis","Aaron", "Abraham", "Adam", "Adrian", "Aidan", "Aiden", "Alan", "Alec", "Alejandro", "Alex", "Alexander", "Alexis",
